...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                setTimeout(() => navigate("/hero"), 3500); // Delay navigation
            } else {
    ...
    return (
        <div className="flex justify-center items-center h-screen bg-gradient-to-r from-black via-gray-900 to-black text-white">
            ...
            <div className="flex flex-col items-center p-10 bg-black bg-opacity-60 backdrop-blur-md border border-orange-500 rounded-2xl shadow-2xl max-w-md w-full transform transition duration-700 hover:scale-105 animate-fadeIn">
                ...
                <form onSubmit={handleSubmit} className="w-full">
                    ...
                    <button 
                        type="submit"
                        className="w-full bg-orange-500 hover:bg-orange-700 transition transform duration-300 text-white p-4 rounded-lg font-bold text-lg shadow-lg hover:scale-105 hover:shadow-orange-700"
                    >
                        Login
                    </button>
                    <p className="flex justify-center mt-6 text-gray-300">
                        Not Registered?
                        <Link to="/register" className="text-orange-400 ml-2 font-semibold hover:underline">Register</Link>
                    </p>
                </form>
            </div>
        </div>
